...
import ps from './CrossAttSidebar.module.scss';
import { ICrossAttProgramState } from './CrossAttProgram';
import { ICrossAttPhaseDef, jumpCrossAttPhase, phaseToCrossAttGroup, CrossAttPhase } from './walkthrough/CrossAttWalkthrough';
...
export let CrossAttProgramStateContext = createContext<ICrossAttProgramState>(null!);

export function useCrossAttProgramState() {
    let context = useContext(CrossAttProgramStateContext);
...
export const CrossAttSidebar: React.FC = () => {
    let progState = useCrossAttProgramState();
...
const CrossAttPhaseMenu: React.FC = () => {
    let progState = useCrossAttProgramState();
    let wt = progState.walkthrough;

    function handlePhaseClick(ev: React.MouseEvent, phase: ICrossAttPhaseDef) {
