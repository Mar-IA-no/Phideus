...
function drawAttentionResidualBypass(render: IRenderState, layer: IPhideusTransformerLayer) {
...
function drawFFNResidualBypass(render: IRenderState, layer: IPhideusTransformerLayer) {
