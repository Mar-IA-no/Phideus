...
import ps from './BloqueaSidebar.module.scss';
import { IBloqueaProgramState } from './BloqueaProgram';
import { IBloqueaPhaseDef, jumpBloqueaPhase, phaseToBloqueaGroup, BloqueaPhase } from './walkthrough/BloqueaWalkthrough';
...
export let BloqueaProgramStateContext = createContext<IBloqueaProgramState>(null!);

export function useBloqueaProgramState() {
    let context = useContext(BloqueaProgramStateContext);
...
export const BloqueaSidebar: React.FC = () => {
    let progState = useBloqueaProgramState();
...
const BloqueaPhaseMenu: React.FC = () => {
    let progState = useBloqueaProgramState();
    let wt = progState.walkthrough;

    function handlePhaseClick(ev: React.MouseEvent, phase: IBloqueaPhaseDef) {
    ...
    return <div className={ps.tocBackground}>
        <div className={ps.tocTitle}>BloqueA Architecture</div>
