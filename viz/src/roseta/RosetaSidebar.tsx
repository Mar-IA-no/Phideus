...
import ps from './RosetaSidebar.module.scss';
import { IRosetaProgramState } from './RosetaProgram';
import { IRosetaPhaseDef, jumpRosetaPhase, phaseToRosetaGroup, RosetaPhase } from './walkthrough/RosetaWalkthrough';
...
export let RosetaProgramStateContext = createContext<IRosetaProgramState>(null!);

export function useRosetaProgramState() {
    let context = useContext(RosetaProgramStateContext);
...
export const RosetaSidebar: React.FC = () => {
    let progState = useRosetaProgramState();
...
const RosetaPhaseMenu: React.FC = () => {
    let progState = useRosetaProgramState();
    let wt = progState.walkthrough;

    function handlePhaseClick(ev: React.MouseEvent, phase: IRosetaPhaseDef) {
    ...
    return <div className={ps.tocBackground}>
        <div className={ps.tocTitle}>RosetaVAE Architecture</div>
