...
export function t3TowerPhase01_AudioCNN(args: IT3TowerWalkthroughArgs) {
    ...
    setT3TowerInitialCamera(state, new Vec3(-140, 0, -20), new Vec3(290, 15, 4));
    ...
    let channels = c_dimRef('channels', T3TowerDim.CNN_channels);
    ...
    moveT3TowerCameraTo(state, t1, new Vec3(-140, 0, -180), new Vec3(290, 15, 4));
