...
## 🚀 DIRECTIVA CRÍTICA: Checkpoints de Training

**SIEMPRE guardar checkpoints en TODAS las epochs.** Usar `--checkpoint-every 1` en todos los scripts de training. No saltear epochs. El costo de disco es despreciable comparado con el valor de poder volver a cualquier punto del training.
...
│   ├── ROADMAP_BIAS_CONTROL.md           # Arquitectura y gates (v1.9)
│   ├── Gate3_DANN_Results/               # ★ Evaluación comparativa Gate 3
│   │   ├── INFORME_GATE3_COMPLETO.md     # Informe exhaustivo 4 Runs
│   │   └── *.json                        # Resultados individuales
...
**Foundation LOCKED**: `foundation_locked_e25.pt` (MD5: ddb2ebf7, chmod 444)
**Best**: Run D-02 epoch 25: S=61.8%, hard_neg=90.4% (multi-seed: S=61.6% ± 1.1%)

| Run | Estrategia | Best S | Best epoch | Hard neg |
|-----|-----------|--------|------------|----------|
...
### BIAS_CONTROL Gate 3 DANN (2026-02-07) - CERRADO ❌

**4 Runs de DANN completados** — ninguno mejora sobre Gate 2. DANN destruye información útil.

**Documentación**: `Documents/BIAS_CONTROL/Gate3_DANN_Results/INFORME_GATE3_COMPLETO.md`
