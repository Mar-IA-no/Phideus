...
| **Atencion Armonica** | Agrupamiento armónico polifónico | Incubacion arquitectonica para testear pair-state, transitividad y `triangle` bajo evidencia per-par ambigua | **Fase 0 cerrada / 0.5 planificada** — pair-state fuerte; `triangle` gana OOD-poly en `AUC/AP`; calibración `ARI@τ` en auditoría |
