...
| Escalon 3 | Audio XY <-> Lissajous | Banco sintetico con ratio visible y control total de parametros | **Activo temprano (`E3-P0` materializado)** |
...
| Escalon 3 | Banco Lissajous con `E3-P0` ya materializado | [ESCALON_3/README.md](Documents/01_FRENTES_ACTIVOS/ESCALON_3/README.md) |
