...
def save_gate42_checkpoint(
    ...
    torch.save({
        ...
        'arch_config': {
            **arch_config,
            ...
            'eval_compatible': descriptor not in ('d4', 'a4', 'a7', 'd4a4', 'd4a7', 'a4x', 'a7x'),
        },
    ...
    if descriptor in ('d4', 'a4', 'a7', 'd4a4', 'd4a7', 'a4x', 'a7x'):
...
def run_evaluate(args):
    ...
    elif descriptor in ('a4', 'a7', 'd4a4', 'd4a7') and eval_bs > 32:
        eval_bs = 32
...
def main():
    ...
    parser.add_argument(
        ...
        choices=['d0', 'd1', 'd2', 'd3', 'd4', 'a4', 'a7', 'd4a4', 'd4a7', 'a4x', 'a7x'],
