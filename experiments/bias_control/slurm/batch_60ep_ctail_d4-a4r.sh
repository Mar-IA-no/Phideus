...
#SBATCH --output=/home/mfmendez/Repos/Phideus/logs/d4a4r-ct60_%j.out
#SBATCH --error=/home/mfmendez/Repos/Phideus/logs/d4a4r-ct60_%j.err

# Cosine-tail 60ep — d4-a4r (D4 concat + A4 reverse, S=79.8% at 30ep)
# LR schedule: cosine like 30ep until LR=0.10 (~e24), then linear tail 0.10→0.02 to e60.
# Hypothesis: d4-a4r has +4.6M params, may benefit most from extended training.
...
echo "=== d4-a4r cosine-tail 60 epochs ==="
...
OUTDIR=/home/mfmendez/results/batch_60ep_ctail_d4-a4r
