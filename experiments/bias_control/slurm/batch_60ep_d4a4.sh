...
#SBATCH --output=/home/mfmendez/Repos/Phideus/logs/d4a4-60_%j.out
#SBATCH --error=/home/mfmendez/Repos/Phideus/logs/d4a4-60_%j.err

# Batch 60ep — d4a4 (dual concat, record holder S=83.6% a 30ep)
# Con 60ep el cosine decay es más lento: LR@e30 ≈ 0.50 (vs 0.0 en 30ep).
...
OUTDIR=/home/mfmendez/results/batch_60ep_d4a4
