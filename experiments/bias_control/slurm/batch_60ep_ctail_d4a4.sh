...
#SBATCH --output=/home/mfmendez/Repos/Phideus/logs/d4a4-ct60_%j.out
#SBATCH --error=/home/mfmendez/Repos/Phideus/logs/d4a4-ct60_%j.err

# Cosine-tail 60ep — d4a4 (dual concat, record holder S=83.6% at 30ep)
...
echo "=== d4a4 cosine-tail 60 epochs ==="
...
OUTDIR=/home/mfmendez/results/batch_60ep_ctail_d4a4
