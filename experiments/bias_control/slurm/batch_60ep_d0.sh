...
#SBATCH --output=/home/mfmendez/Repos/Phideus/logs/d0-60_%j.out
#SBATCH --error=/home/mfmendez/Repos/Phideus/logs/d0-60_%j.err

# Batch 60ep — D0 baseline (control)
# Misma config que runs de 30ep pero con 60 epochs.
# Cosine LR se estira: a e30 el LR mult ≈ 0.50 (vs 0.0 en run de 30ep).
...
echo "=== D0 baseline scratch 60 epochs ==="
...
OUTDIR=/home/mfmendez/results/batch_60ep_d0
