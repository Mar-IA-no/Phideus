...
# Cosine-tail 60ep — D0 control (baseline, no descriptor)
# LR schedule: cosine like 30ep until LR=0.10 (~e24), then linear tail 0.10→0.02 to e60.
# Purpose: control — if D0 improves, gains are from scheduler, not descriptors.
...
OUTDIR=/home/mfmendez/results/batch_60ep_ctail_d0
