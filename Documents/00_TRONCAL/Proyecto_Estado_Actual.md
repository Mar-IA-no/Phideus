...
> **Núcleo arquitectónico proporcional**: la cadena CPU ya probó abstención, potencia, localización topológica y una interfaz heteroscedástica de riesgo bajo realizaciones disjuntas. R360 mantiene evidencia de que las veinticuatro features topology superan base y sham matched en grouped/balanceado; R361 muestra que modelar `log(|delta-mu|)` y conformalizar `mu+q*sigma` no convierte esa señal en política útil. Aunque el firewall permitió los `12/12` gates principales, topology actuó sólo en `13/2.032` decisiones brazo-vista de adjudicación, copió identidad en ambos typed y no obtuvo ningún intervalo favorable frente a identidad. Su ajuste OOF tampoco superó uniformemente a public-base o topology-permuted. Los `80.320/80.320` solves convergieron y el replay igualó `98/98` archivos deterministas. La oportunidad CPU siguiente es auditar una interfaz unilateral sobre el residuo firmado antes de abrir otra realización; no hay arquitectura promovida ni GO/NO-GO y la GPU sigue en cola.
...
*Documento revisado el 2026-09-04. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local ya adjudicó por CPU una interfaz condicional de riesgo sobre la representación topológica. El resultado conserva seguridad mediante acción casi nula y desplaza el próximo diagnóstico hacia la cola firmada; toda etapa GPU permanece en cola. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
