...
> **Núcleo arquitectónico proporcional**: la cadena CPU ya probó abstención, potencia y localización topológica bajo realizaciones disjuntas. El gate topology de veinticuatro features actuó en `23,4–31,7%` de IID y `62,7–68,7%` de grouped; superó a public-base y a un sham de igual dimensión con correcciones permutadas en grouped y balanceado `4/4`. Frente a identidad mejoró grouped `4/4` (`-0,00663..-0,00963`) y balanceado `4/4`, mientras IID quedó incierto con puntos no negativos. La banda simultánea seleccionó identidad en `12/12` gates y `128/128` controles, de modo que hay valor causal parcial de representación pero no política safe. Los `60.400/60.400` solves convergieron y el replay igualó `76/76` artefactos. El próximo diseño CPU conserva topology y cambia sólo la interfaz de riesgo mediante un límite superior de daño IID por alpha. No hay arquitectura promovida ni GO/NO-GO; GPU queda en cola.
...
*Documento revisado el 2026-09-04. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local ya ejecutó por CPU abstención, potencia y localización topológica con controles matched. El próximo corte diseña una interfaz selectiva de riesgo IID; toda etapa GPU permanece en cola. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
