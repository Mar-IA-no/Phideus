...
> [!IMPORTANT]
> **Actualizado**: 2026-08-31 (Olas 26–29 de ground truth proporcional integradas y auditadas en su alcance; conserva el corte experimental consolidado al 2026-07-02)
...
*Documento revisado el 2026-08-31. El corte experimental general sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: veintinueve olas de ground truth proporcional quedaron integradas como base estratificada. La Ola 26 añadió cuatro anclas checker-only ejecutadas y reproducibles; ese alcance no se extiende a las diecisiete entradas restantes ni a modelos. La Ola 27 conserva veintidós bancos documentales sin ejecución. La Ola 28 ejecutó veintidós suite-bank IDs exactos y reproducibles en cinco suites: trece en la suite mínima, dos sobre no-identificación p-ádica y dimensión del tight span, dos sobre proyección ultramétrica con óptimos múltiples y margen de resolución de cuartetos, tres sobre building de Bruhat–Tits, gauge de presentación y preflight no métrico, y dos sobre autoridad bajo observación parcial y lassos. La Ola 29 especificó y reauditó B-03/B-06/B-16 como guards convencionales todavía no ejecutados. El antiguo `22/33` queda sólo como índice histórico de materialización entre granularidades distintas; el inventario raw vigente es `9 fully / 20 partial / 4 not`. `Response-Quotient Atlas`, `Experiment-Relative Geometry Atlas`, `Identified-Set Authority Stack`, `Guaranteed Set Transformer Stack`, `Set Geometry Authority Contract`, `Intrinsic Object Authority Contract`, `Positive/Operator Authority Contract` y `Hierarchy/Tree Authority Contract` amplían el atlas con objetos, outputs y jurisdicciones tipadas, pero siguen sin constituir una arquitectura promovida. No se declaró GO/NO-GO.*
