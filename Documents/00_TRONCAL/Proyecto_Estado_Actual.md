...
> [!IMPORTANT]
> **Actualizado**: 2026-08-30 (Ola 24 de ground truth proporcional integrada, reauditada y respaldada; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de cuarenta y ocho investigaciones independientes y dos carriles reconstruidos por el coordinador, organizados en veinticuatro olas, no encontró una geometría universal ni un corpus único. Propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, experimento, operador, constitución, identificabilidad, solver, reader y autoridad. Las Olas 20–23 distinguieron operador, respuesta, experimento y verdad set-valued. La Ola 24 agregó que, si una PPU transforma un conjunto autorizado, semántica, dominio, propuesta, checker, composición, pérdida y reader deben conservar licencias separadas. `Guaranteed Set Transformer Stack` formaliza esa condición: `v0` cambia sólo el transformer y cruza learned/classical/sham con checker y repair comunes. F01–F08 quedaron cerrados por reauditoría independiente, pero la suite no fue implementada ni ejecutada. `A10` y `A11` siguen como especializaciones; `A14` sigue como interfaz; no hay `A19`, GO/NO-GO ni arquitectura promovida.
