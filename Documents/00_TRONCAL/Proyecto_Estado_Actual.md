...
12. **Reorientar desde el contraste geométrico ejecutado**: el lector estructurado completó cuatro tests frescos y sus auditorías de evidencia y alineación. El factor conjunto no muestra ventaja clara sobre controles en polifonía, pierde ARI medio en otros dos shifts y aumenta fragmentación frente a Pares. El siguiente contraste es el [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md), con [protocolo auditado](../../experiments/atencion_armonica/PROTOCOL_LEARNED_PARTITION_READER.md). Su ejecutor ya conecta datos, normalización train-only, entrenamiento recuperable, selección y evaluación. Las reauditorías focales verificaron recuperación, métricas de intervenciones y almacenamiento empaquetado; falta completar y auditar la proyección de la validación transitiva antes de perfilar. Las fixtures CPU no sustituyen las corridas aprendidas: todavía no se ejecutaron perfiles ni datos prospectivos, y el freeze de selección sigue pendiente de evidencia real. Este resultado no es una refutación general de la geometría ni demuestra la necesidad de otra observación. La extensión física set-valued permanece pausada e incompleta, sin promoción ni cierre prospectivo.
