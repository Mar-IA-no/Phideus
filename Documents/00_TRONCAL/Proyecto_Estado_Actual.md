...
> [!IMPORTANT]
> **Corte geométrico 2026-09-08**: el [lector estructurado](../../experiments/atencion_armonica/RESULTS_SOURCE_STRUCTURED_READER.md) completó calibración y cuatro tests frescos con replay exacto, sin nuevos trainings. Sobre checkpoints BCE congelados y candidatos comunes, el factor conjunto no muestra ventaja clara de ARI frente a controles en mayor polifonía; pierde ARI medio en mayor inarmonicidad y familia deformada, y aumenta fragmentación frente a Pares. La auditoría final cerró sin hallazgos materiales. El resultado pertenece a una operación de inferencia: no demuestra geometría neuronal aprendida ni identifica fuentes físicas. No hay arquitectura promovida.
...
| Atención Armónica | Lector estructurado ejecutado; auditorías de evidencia y alineación completas | Cuatro tests frescos y replay; sin ventaja clara del factor conjunto en polifonía frente a controles comunes. Fases `0–0.6` históricas conservadas, sin certificar ausencia del canal global de amplitudes |
...
12. **Reorientar desde el contraste geométrico ejecutado**: el lector estructurado completó cuatro tests frescos; el factor conjunto no mostró ventaja clara en polifonía y perdió ARI medio en otros dos shifts. El [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md) prueba ahora si esa decisión puede aprenderse, bajo un [protocolo auditado](../../experiments/atencion_armonica/PROTOCOL_LEARNED_PARTITION_READER.md). El [sexto corte](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_RESOURCE_PROFILE.md) terminó las 36 corridas CPU previstas, con 50 épocas cada una, y la selección común por brazo pasó su auditoría independiente. Tras recuperar la normalización sin cambiar sus arrays, IID completó inferencia, evaluación y replay exclusivamente CPU. El [balance parcial](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_IID.md) pasó su auditoría independiente sin hallazgos materiales en ese alcance; no sustituye el primario de mayor polifonía. Mayor inarmonicidad completó evaluación y replay; polifonía se detuvo en inferencia por un falso rechazo numérico del soporte. La recuperación acotada pasó su auditoría y completó inferencia de polifonía con los once archivos previos exactamente preservados; la evaluación posterior se detuvo por RAM. La liberación anticipada de objetos ya serializados pasó su auditoría, pero el reintento volvió a exceder el mismo límite; la enmienda explícita a 4 GiB pasó su auditoría y la evaluación se reanudó. La familia deformada sigue pendiente, sin cambiar escenas, receta ni selección. Checkpoints, calibraciones e intentos fallidos permanecen preservados. La extensión física set-valued sigue pausada e incompleta; no hay arquitectura promovida ni cierre del goal.
