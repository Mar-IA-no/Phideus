...
> [!IMPORTANT]
> **Actualizado**: 2026-09-03 (Olas 26–54 de ground truth proporcional integradas; la Ola 54 modeló conjuntamente los quince conjuntos sobre logits congelados, mejoró NLL/cardinalidad e identificó señal de interacción, pero no alcanzó el patrón decisional predeclarado; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de cincuenta y cuatro olas y ciento ocho investigaciones independientes no encontró una geometría universal ni un corpus único. Organizó fuentes analíticas, simulación generativa, cámaras físicas y evidencia externa bajo falsación adversarial y adjudicación ciega. Las Olas 20–48 construyeron contratos para objeto, unidades, equivalencia, identificabilidad, transformación, autoridad material y autoridad de la relación. La Ola 49 materializó un benchmark clásico sellado; las Olas 50–52 separaron conjunto, elección y utilidad contractual; y la Ola 53 mostró que transportar incertidumbre marginal mejora compatibilidad y abstención sin resolver regret ni dependencia. La Ola 54 sustituyó el producto Bernoulli por un posterior conjunto identificado de doce parámetros sobre los quince estados: redujo NLL frente a Platt independiente (`-0.0818`), mejoró cardinalidad (`-0.0871` L1) y obtuvo señal adicional de interacción (`-0.0488` NLL frente a unary+cardinalidad), pero perdió accuracy frente al conjunto duro (`-0.0577`), no alcanzó el margen de regret y quedó por debajo del control shuffled predeclarado. El patrón conjunto fue falso con replay exacto. El próximo discriminante se ubica en la interfaz posterior–decisión y en la cobertura de los cinco conjuntos ausentes, no en escalar el encoder. El patrón acumulado separa `contrato material del target -> autoridad de relación/equivalencia -> manifest/attestation -> proposer o selector -> oracle/checker -> conjunto identificado con incertidumbre -> política de decisión -> abstención -> audit/replay -> reader`. No hay `A19`, nuevo `P2*`, arquitectura promovida ni decisión GO/NO-GO.
...
*Documento revisado el 2026-09-03. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cuatro olas. La Ola 54 mostró que un posterior conjunto corrige parte de la dependencia y la cardinalidad que las marginales perdían, pero esa mejora representacional todavía no se convierte en una ventaja decisional suficiente. No constituye una PPU validada ni una decisión GO/NO-GO.*
