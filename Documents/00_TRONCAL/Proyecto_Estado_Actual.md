...
| Atención Armónica | Lector aprendido: 36 trainings, cuatro tests y replays completos; auditorías completas | Primario favorable frente a Pares/Desacoplada, no claro frente a Local; daño en familia deformada. Fases `0–0.6` históricas conservadas, sin certificar ausencia del canal global de amplitudes |
...
12. **Diagnosticar la correspondencia entre operación y objetivo**: el [contraste generativo completo](../../experiments/atencion_armonica/RESULTS_GENERATIVE_EVIDENCE_READER.md) distingue alineación útil del canal y utilidad incremental todavía no clara frente a Local en el primario. El [relevo CPU](../../experiments/atencion_armonica/PLAN_OPERATOR_OBJECTIVE_ALIGNMENT.md) separará cobertura, orden geométrico, target verdadero y error de lectura, sin entrenar sobre los tests abiertos ni atribuir causalmente la brecha con el sistema clásico. La extensión física set-valued sigue pausada e incompleta; promoción y GO/NO-GO siguen siendo decisiones del usuario.
