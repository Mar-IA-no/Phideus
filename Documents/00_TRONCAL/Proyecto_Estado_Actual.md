...
> [!IMPORTANT]
> **Corte geométrico 2026-09-08**: el [diagnóstico de coherencia de fuente](../../experiments/atencion_armonica/RESULTS_SHARED_SOURCE_COHERENCE.md) completó 96 escenas y replay CPU. Los gradientes finales no identifican la causa del resultado neuronal, y un buen ajuste de parámetros compartidos no garantiza pertenencia a una fuente única. El siguiente [lector estructurado](../../experiments/atencion_armonica/PLAN_SOURCE_STRUCTURED_READER.md) tiene diseño reauditorado y aún no está implementado: hará actuar factores de grupo sobre candidatos comunes, con checkpoints BCE congelados, controles y datos frescos. No hay arquitectura promovida ni nueva evidencia prospectiva.
...
| Atención Armónica | Contraste neuronal y diagnóstico de coherencia completos; siguiente diseño | Compatibilidad empeora Brier frente a BCE en OOD beta; el fit conjunto posterior no identifica pertenencia. Lector estructurado diseñado, aún no ejecutado. Fases `0–0.6` históricas conservadas, sin certificar ausencia del canal global de amplitudes |
...
12. **Hacer actuar la coherencia de grupo en la inferencia**: el contraste neuronal y su diagnóstico CPU están ejecutados. La operación de ajuste no identifica pertenencia ni explica causalmente entrenamiento. El siguiente diseño compara un lector estructurado con factores de grupo frente a controles sobre el mismo pool, con datos frescos y checkpoints BCE congelados; está reauditorado, no implementado. La extensión física set-valued permanece pausada e incompleta, sin promoción ni cierre prospectivo.
