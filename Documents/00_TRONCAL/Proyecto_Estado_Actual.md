...
> **Ground truth proporcional / PPU**: una campaña de veintiséis investigaciones independientes, organizadas en doce olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, operador, constitución, identificabilidad, solver, reader y autoridad. La octava ola agregó `A7/P2g/P2h`; la novena, `A8/P2i/P2j`; la décima, `A9/P2k` y `P5e`; la undécima, los firewalls `P2l/P2m`. La duodécima añadió `P2n`, que separa equivariancia, conmutatividad paired, projectivity en ley y extendibilidad, y `P2o`, que separa tropicalidad exacta, dequantización y ajuste PWL. `A10` y `A11` quedan como especializaciones experimentales de arquitecturas previas; `A12` es un bloque max-plus proyectivo estrecho. No son experimentos ejecutados; no hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-29. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: doce olas de ground truth proporcional quedaron integradas como base estratificada, con candidatas hasta A12 y contratos auditables hasta P2o/P5e. A10 y A11 siguen como especializaciones, A12 como bloque estrecho; no se promovió arquitectura ni se declaró GO/NO-GO.*
