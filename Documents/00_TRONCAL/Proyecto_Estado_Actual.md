...
> [!IMPORTANT]
> **Actualizado**: 2026-09-07. El ciclo de [geometría armónica computable](ROADMAP_GENERAL/PROGRAMA_GEOMETRIA_ARMONICA_COMPUTABLE.md) ya produjo un [contraste neuronal completo](../../experiments/atencion_armonica/RESULTS_SHARED_PARTIAL_STUDY.md): quince trainings y cinco tests, con representación y descriptores comunes para comparar pérdidas. Tras retirar el canal de amplitudes del banco, la penalización física empeoró Brier frente a BCE en las tres semillas del escenario primario; su promedio favorable frente a otros regularizadores no fue uniforme entre semillas. La lectura de particiones mostró otra ordenación, lo que orienta un diagnóstico de coherencia geométrica global y efecto de la pérdida sobre los estados guardados. La extensión física set-valued queda pausada e incompleta; no se promueve una arquitectura ni se extrapola a audio observado.
...
| Atención Armónica | Contraste de pérdidas completo; análisis activo | Quince trainings y cinco tests frequency-only: compatibilidad empeora Brier frente a BCE en OOD beta; continúa diagnóstico post-hoc de coherencia y pérdida. Fases `0–0.6` históricas conservadas, sin certificar ausencia del canal global de amplitudes |
...
12. **Interpretar y continuar el ciclo geométrico**: el contraste de compatibilidad completó quince trainings y cinco tests. La evidencia no sostiene mejora de esta pérdida sobre BCE en el escenario primario; la disociación entre Brier y partición orienta una pregunta sobre coherencia global y presión de la pérdida, sin reentrenar por inercia. El cierre requiere auditoría de resultados y alineación, y un sucesor finito justificado. La extensión física set-valued permanece pausada e incompleta, sin promoción ni cierre prospectivo.
