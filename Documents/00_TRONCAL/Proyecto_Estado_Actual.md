...
> **Ground truth proporcional / PPU**: una campaña de catorce investigaciones independientes, organizadas en seis olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación causal, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La candidata arquitectónica separa objeto y unidades, operador estructural, constitución o autoridad geométrica, solver y reader. La quinta ola agregó complejos/Hodge y sheaves como maquinaria auditable de compatibilidad local-global; la sexta separó Fisher–Rao, Aitchison, Wasserstein y GW según semántica, modelo y costo, e introdujo controles contra privilegio, optimizer-only y matching no causal. Redes resistivas, estequiometría, soluciones manufacturadas, sampling sheaves y bancos exactos de información/transporte son candidatos de alto poder diagnóstico. No hay GO/NO-GO ni arquitectura promovida.
