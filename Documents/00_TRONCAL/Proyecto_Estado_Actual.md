...
> [!IMPORTANT]
> **Actualizado**: 2026-08-30 (Ola 14 de ground truth proporcional integrada y auditada; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de treinta investigaciones independientes, organizadas en catorce olas integradas, no encontró una geometría universal ni un corpus único. Propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, operador, constitución, identificabilidad, solver, reader y autoridad. La duodécima ola añadió `P2n/P2o`; la decimotercera, `A13/P2p` y la interfaz no agregable `A14a/b/c/P2q`. La decimocuarta agregó `A15/P2r`, contracción direccional después de inferir una tabla parcial bajo contratos observacionales congelados, y `A16/P2s`, scorer assignment aditivo condicionado a topología pública conocida. El único puente formal es que el soporte Lorentziano homogéneo es M-convexo; no se infiere una tropicalización común. `A10` y `A11` siguen como especializaciones; las demás son candidatas o interfaces no ejecutadas. No hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-30. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: catorce olas y treinta investigaciones de ground truth proporcional quedaron integradas como base estratificada. A15/P2r aísla contracción direccional después de inferir una tabla parcial bajo máscara, gauge y queries congeladas; A16/P2s aísla un scorer assignment aditivo con topología pública conocida y executor común. El soporte M-convexo es el único puente formal entre los carriles de la Ola 14; no se postuló una tropicalización común. A10 y A11 siguen como especializaciones, A14 como interfaz de tres candidatos; no se promovió arquitectura ni se declaró GO/NO-GO.*
