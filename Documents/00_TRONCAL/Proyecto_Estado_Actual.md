...
> [!IMPORTANT]
> **Actualizado**: 2026-09-07. Nuevo ciclo de [geometría armónica computable](ROADMAP_GENERAL/PROGRAMA_GEOMETRIA_ARMONICA_COMPUTABLE.md): diseño conjunto de representación, arquitectura, pérdida y evaluación, con Atención Armónica como banco inicial. El primer diagnóstico CPU del banco está planificado; todavía no hay evidencia experimental nueva. La extensión física set-valued queda pausada e incompleta. El corte experimental general se conserva; no se promueve una arquitectura.
...
| `Documents/01_FRENTES_ACTIVOS/Atencion_Armonica/ROADMAP_ATENCION_ARMONICA.md` | Nuevo ciclo de geometría, arquitectura y pérdida; diagnóstico del banco antes del contraste neuronal, con Stage B/detección como alternativas preservadas |
