...
12. **Reorientar desde el contraste geométrico ejecutado**: el lector estructurado completó cuatro tests frescos y sus auditorías de evidencia y alineación. El factor conjunto no muestra ventaja clara sobre controles en polifonía, pierde ARI medio en otros dos shifts y aumenta fragmentación frente a Pares. El siguiente contraste es el [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md), con [protocolo auditado](../../experiments/atencion_armonica/PROTOCOL_LEARNED_PARTITION_READER.md) e implementación en curso. Al núcleo recuperable se agregaron datos por shards, normalizadores train-only, perfiles preparados y supervisión de las primeras etapas, con pruebas CPU. Faltan las corridas aprendidas y su recuperación acumulativa, el freeze y la auditoría integral; todavía no se ejecutaron perfiles ni datos prospectivos. Este resultado no es una refutación general de la geometría ni demuestra la necesidad de otra observación. La extensión física set-valued permanece pausada e incompleta, sin promoción ni cierre prospectivo.
