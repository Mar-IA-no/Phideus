...
> [!IMPORTANT]
> **Actualizado**: 2026-08-30 (Ola 15 de ground truth proporcional integrada y auditada; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de treinta y dos investigaciones independientes, organizadas en quince olas integradas, no encontró una geometría universal ni un corpus único. Propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, operador, constitución, identificabilidad, solver, reader y autoridad. La decimocuarta ola agregó `A15/P2r` y `A16/P2s` para operaciones cerradas bajo observación parcial. La decimoquinta agregó `A17/P2t`, completación de distancia bajo un bottleneck de log-ratios y aplicabilidad explícita, y `A18/P2u`, inferencia y ejecución local de una columna de exchange sólo en contextos cuya órbita es identificable por enumeración exacta. Ambos protocolos están auditados y cerrados programáticamente, no ejecutados. `A10` y `A11` siguen como especializaciones; `A14` sigue como interfaz; no hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-30. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: quince olas y treinta y dos investigaciones de ground truth proporcional quedaron integradas como base estratificada. A17/P2t aísla el valor de un bottleneck de log-ratios dentro de una arquitectura de cuñas fija y obliga a detectar cuándo la completación es identificable. A18/P2u separa inferir una órbita de columna de ejecutar la mutación local sobre queries retenidas, con version space y split exactos. Ambos protocolos siguen sin ejecución. A10 y A11 permanecen como especializaciones y A14 como interfaz de tres candidatos; no se promovió arquitectura ni se declaró GO/NO-GO.*
