...
> [!IMPORTANT]
> **Actualizado**: 2026-09-07. Nuevo ciclo de [geometría armónica computable](ROADMAP_GENERAL/PROGRAMA_GEOMETRIA_ARMONICA_COMPUTABLE.md): diseño conjunto de representación, arquitectura, pérdida y evaluación, con Atención Armónica como banco inicial. El [diagnóstico de amplitudes](../../experiments/atencion_armonica/RESULTS_ENERGY_PARTITION_AUDIT.md) mostró un canal no frecuencial accesible en la muestra histórica, sin atribuir su uso a las redes. El contraste vigente retira ese canal y compara pérdidas con red/descriptores comunes. Su [preflight CPU](../../experiments/atencion_armonica/RESULTS_SHARED_PARTIAL_PREFLIGHT.md) y [perfil GPU](../../experiments/atencion_armonica/RESULTS_SHARED_PARTIAL_GPU_PROFILE.md) están completos; la celda de entrenamiento está auditada. Faltan terminar coordinador/evaluación y ejecutar el contraste. La extensión física set-valued queda pausada e incompleta; no se promueve una arquitectura.
...
12. **Ejecutar el nuevo ciclo geométrico**: terminar coordinador/evaluación del contraste de compatibilidad entre parciales y entrenar los brazos con controles congelados. El núcleo, preflight CPU y perfil GPU están completos; la celda de training está auditada, pero no hay todavía mejora aprendida evaluada. El goal requiere un contraste experimental completo, no otro cierre de preparación. La extensión física set-valued permanece pausada e incompleta; su preflight histórico sigue conservado, sin promoción ni cierre prospectivo.
...
| `Documents/01_FRENTES_ACTIVOS/Atencion_Armonica/ROADMAP_ATENCION_ARMONICA.md` | Preflight de compatibilidad completo; runner y entrenamiento pendientes, con Stage B/detección como alternativas preservadas |
