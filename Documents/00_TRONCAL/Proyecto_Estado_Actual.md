...
> [!IMPORTANT]
> **Actualizado**: 2026-08-30 (Ola 19 de ground truth proporcional integrada y auditada; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de treinta y ocho investigaciones independientes y dos carriles reconstruidos por el coordinador, organizados en diecinueve olas, no encontró una geometría universal ni un corpus único. Propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, operador, constitución, identificabilidad, solver, reader y autoridad. La decimoquinta ola agregó `A17/P2t` y `A18/P2u`; la decimosexta registró `P2v` como diagnóstico y bloqueó circle patterns por fuga local; la decimoséptima registró `P2a-G` y dejó phase/closure en preflight. La decimoctava separó invariancia de separación orbital y estabilidad topológica de suficiencia o autoridad de filtración. La decimonovena agregó dos suites P0 auditadas: una para autoridad armónica/orbital y otra para estado predictivo, con inputs igualados, ley del proceso hasheada y solver access tipado. Los protocolos registrados están auditados y programáticos, no ejecutados. `A10` y `A11` siguen como especializaciones; `A14` sigue como interfaz; no hay `A19`, GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-30. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: diecinueve olas de ground truth proporcional quedaron integradas como base estratificada. A17/P2t aísla completación identificable, A18/P2u separa inferencia de órbita y ejecución local, P2v diagnostica cocientes de forma y P2a-G separa residual analítico, mixer group-aware y solver. Circle patterns y phase/closure permanecen en preflight; representación orbital, autoridad de filtración, autoridad armónica y estado predictivo permanecen como suites diagnósticas. Los protocolos siguen sin ejecución; no se promovió arquitectura ni se declaró GO/NO-GO.*
