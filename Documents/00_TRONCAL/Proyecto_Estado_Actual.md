...
> **Ground truth proporcional / PPU**: una primera campaña de ocho investigaciones independientes, organizadas en tres olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación causal, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. El próximo movimiento posible es elegir y diseñar los tracks exactos de unidades/Buckingham y composición/ciclos; no hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-29. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: la primera campaña de ground truth proporcional quedó integrada como base estratificada para PPU/NHG, sin promover arquitectura ni declarar GO/NO-GO.*
