...
> **Ground truth proporcional / PPU**: una campaña de veinticuatro investigaciones independientes, organizadas en once olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, operador, constitución, identificabilidad, solver, reader y autoridad. La octava ola agregó `A7/P2g/P2h`; la novena, `A8/P2i/P2j`; la décima, `A9/P2k` y el banco perceptual `P5e`. La undécima añadió `P2l`, que separa factibilidad finita, meaningfulness, verdad y autoridad, y `P2m`, que separa chequeo, ejecución y discovery de abstracciones causales bajo privilegios tipados y controles anti-colapso. La `A10` del catálogo PPU queda como especialización causal experimental de A7/A9, no como arquitectura independiente: sólo un bloque de conmutatividad con aporte sobre su ablación exacta podría ascender. No son experimentos ejecutados; no hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-29. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: once olas de ground truth proporcional quedaron integradas como base estratificada, arquitecturas candidatas A0–A9, una especialización causal A10 aún protocolaria y contratos auditables de medición, adquisición, escala, percepción y abstracción causal para PPU/NHG, sin promover arquitectura ni declarar GO/NO-GO.*
