...
> [!IMPORTANT]
> **Actualizado**: 2026-09-03 (Olas 26–55 de ground truth proporcional integradas; el núcleo local de coherencia proporcional ya ejecutó contrato, clásicos y smoke neuronal factorial CPU de dos seeds con replay byte-exacto; conserva el corte experimental consolidado al 2026-07-02)
...
*Documento revisado el 2026-09-03. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local ya cuenta con contrato, clásicos y smoke neuronal factorial CPU ejecutados y reproducidos. El próximo corte arquitectónico desentrelaza relación, peso y solver desde los crudos, sólo por CPU. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
