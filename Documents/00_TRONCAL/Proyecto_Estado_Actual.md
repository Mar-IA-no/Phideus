...
> [!IMPORTANT]
> **Actualizado**: 2026-09-03 (Olas 26–51 de ground truth proporcional integradas; la Ola 51 probó y reprodujo en CPU una arquitectura de conjunto+elección sobre datos históricos abiertos; conserva el corte experimental consolidado al 2026-07-02)
...
*Documento revisado el 2026-09-03. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y una olas. La Ola 50 mostró que una salida sigmoid conserva más alternativas compatibles que softmax, aunque sin satisfacer su patrón conjunto. La Ola 51 probó la separación más directa entre cabeza de conjunto y cabeza de elección: la segunda aprendió señal frente al shuffle, pero no produjo una mejora del sistema y el congelamiento sacrificó aprendizaje del conjunto. La interfaz conceptual sigue abierta; la receta two-stage simple queda negativa y reproducida. No constituye una PPU validada ni una decisión GO/NO-GO.*
