...
> [!IMPORTANT]
> **Actualizado**: 2026-09-03 (Olas 26–55 de ground truth proporcional integradas; el nuevo núcleo local de coherencia proporcional ejecutó y auditó su contrato y baselines clásicos CPU sobre `256` masters, antes del smoke neuronal; conserva el corte experimental consolidado al 2026-07-02)
...
> **Núcleo arquitectónico proporcional**: el programa dejó de ampliar la taxonomía y empezó un contraste concreto sobre grafos de log-razones. El primer escalón ya ejecutó contrato anti-leakage, checker, WLS, Huber-IRLS y referencia oracle sobre `256` masters / `320` vistas: no hubo fallos IRLS, el replay fue byte-exacto y la suite ampliada dio `173 passed`. IRLS mejora a WLS en todos los slices, pero se degrada bajo corrupción agrupada (`0.109 -> 0.178` de RMSE de cociente en test), confirmando una dificultad útil sin acreditar todavía al mixer. Sigue pendiente el smoke neuronal `RAW/CLOSURE × GENERIC/TYPED`; no hay arquitectura promovida ni GO/NO-GO.
...
*Documento revisado el 2026-09-03. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local posterior ya cuenta con contrato y baselines clásicos ejecutados. El próximo corte arquitectónico es un smoke neuronal factorial en CPU. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
