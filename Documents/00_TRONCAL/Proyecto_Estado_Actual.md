...
> **Protocolo operativo Codex ↔ Claude**: para Escalón 3 y frentes siguientes queda fijada una regla de trabajo más nítida. Codex debe concentrarse en diseño experimental, auditoría, lectura metodológica y documentación; Claude debe concentrarse en implementación, ejecución, tuning operativo, monitoreo y corridas largas. La intención no es burocrática: es usar mejor las fortalezas reales de cada agente sin perder comparabilidad ni trazabilidad.
...
| `Documents/00_TRONCAL/PROTOCOLO_OPERATIVO_CODEX_CLAUDE.md` | Reparto operativo recomendado entre agentes: Codex como dueño de método/auditoría/documentación y Claude como dueño de implementación/ejecución/monitoreo |
