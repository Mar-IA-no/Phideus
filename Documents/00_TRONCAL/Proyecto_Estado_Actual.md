...
> [!IMPORTANT]
> **Actualizado**: 2026-09-05 (Olas 26–59 integradas; el bracket HGB prospectivo cerró ambos patrones como falsos bajo controles de desplazamiento matched y replay exacto, sin promover arquitectura ni declarar techo; el núcleo local mantiene además sus adjudicaciones de localización y riesgo; corte histórico consolidado al 2026-07-02)
...
*Documento revisado el 2026-09-05. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y nueve olas. La Ola 59 volvió prospectivo el bracket HGB/HGB y cerró falsos ambos patrones: hay mejoras locales frente a hard, pero no separación de los controles matched y el brazo de harm tampoco preserva compatibilidad. El núcleo local dispone además de una interfaz checker-valid para representar la ruta IID/grouped y de un puerto de utilidad probado sólo sobre fixtures sintéticos; se evaluaron cero rutas históricas con utilidad. El modo Colab queda retirado. CPU continúa autónoma cuando es el recurso proporcionado; toda etapa para la cual GPU sea necesaria o materialmente más eficiente se detiene antes de ejecutarse, se informa por Telegram con objetivo, duración y VRAM estimados, y espera indicación del usuario. Esto no constituye una PPU validada, un techo ni una decisión GO/NO-GO.*
