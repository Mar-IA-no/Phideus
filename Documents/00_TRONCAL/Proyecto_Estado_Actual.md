...
12. **Reorientar desde el contraste geométrico ejecutado**: el lector estructurado completó cuatro tests frescos; el factor conjunto no mostró ventaja clara en polifonía y perdió ARI medio en otros dos shifts. El [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md) prueba ahora si esa decisión puede aprenderse, bajo un [protocolo auditado](../../experiments/atencion_armonica/PROTOCOL_LEARNED_PARTITION_READER.md). Train y calibración están preparados. Tras corregir un falso rechazo numérico y su recuperación bajo una reserva activa, el [sexto corte](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_RESOURCE_PROFILE.md) completó perfiles e importación auditada de la misma cohorte. El entrenamiento CPU terminó las 36 corridas previstas, con 50 épocas cada una; checkpoints y calibraciones están preservados. Sigue la selección común por brazo y su auditoría independiente antes de abrir los cuatro tests nuevos. Los forwards congelados conservan su etapa GPU; el intento anterior y su débito permanecen registrados, sin cambiar escenas ni receta. Todavía no hay resultados de test del lector aprendido. La extensión física set-valued sigue pausada e incompleta; no hay arquitectura promovida.
