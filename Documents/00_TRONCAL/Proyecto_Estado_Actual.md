...
> **Ground truth proporcional / PPU**: una campaña de dieciocho investigaciones independientes, organizadas en ocho olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La candidata arquitectónica separa objeto y unidades, operador estructural, constitución o autoridad geométrica, solver y reader. La octava ola agregó un identificador-compilador certificado: cruza consultas observacionales, predictivas, interventionales y contrafactuales con identificabilidad estructural/práctica y anclaje físico; además separa proposer, IR, solver, checker, estatuto formal, autoridad causal/física y decisión. Los contratos `P2g/P2h` igualan acceso, unidad, arquitectura × solver y controles algebraicos por efecto esperado. Son candidatos auditados, no experimentos ejecutados. No hay GO/NO-GO ni arquitectura promovida.
