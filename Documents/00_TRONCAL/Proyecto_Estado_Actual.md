...
12. **Reorientar desde el contraste geométrico ejecutado**: el lector estructurado completó cuatro tests frescos y sus auditorías de evidencia y alineación. El factor conjunto no muestra ventaja clara sobre controles en polifonía, pierde ARI medio en otros dos shifts y aumenta fragmentación frente a Pares. El siguiente contraste es el [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md), con [protocolo auditado](../../experiments/atencion_armonica/PROTOCOL_LEARNED_PARTITION_READER.md). Su ejecutor conecta datos, normalización train-only, entrenamiento recuperable, selección y evaluación. Las auditorías verificaron recuperación, intervenciones, almacenamiento y validación transitiva. Los [perfiles mecánicos](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_RESOURCE_PROFILE.md) ya midieron geometría, training CPU y training 3090; tras corregir runtime y soporte, la autorización se detuvo por el presupuesto operativo. La enmienda aprobada eleva los topes de tiempo sin cambiar memoria ni diseño científico y exige nuevos perfiles coherentes antes de datos. La regla prefijada favorecía CPU para las cabezas pequeñas y mantenía los forwards congelados en GPU; el nuevo corte debe volver a aplicar esa misma regla. Todavía no hay datos prospectivos ni corridas aprendidas, y el freeze de selección sigue pendiente de evidencia real. La extensión física set-valued permanece pausada e incompleta, sin promoción ni cierre prospectivo.
