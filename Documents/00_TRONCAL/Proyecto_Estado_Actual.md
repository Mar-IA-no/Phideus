...
> **Núcleo arquitectónico proporcional**: la cadena CPU ya probó abstención, potencia, localización topológica y tres interfaces de riesgo. R363 mostró que topology transporta ajuste OOF pero no política bajo cobertura simultánea: signed-tail actuó `5/2.040` veces y no superó identidad, absolute ni sham. R364 propuso primero un alpha y calibró después sólo su residuo: redujo todos los cuantiles y subió topology a `14/2.040` acciones, sin separarlo de constant, public-base o control permutado. R365 reaplicó esa interfaz a dos cohortes abiertas: el firewall topology cambió de `1/4` a `4/4`, `7/12` signos contra el control matched fueron inestables y los dos favorables en ambas cohortes proyectaron `4.993–8.900` masters. Otra realización de unas `250` unidades no tiene poder diagnóstico plausible bajo esos efectos. El próximo cuello CPU es compartir espacio candidato y propuesta de alpha, e igualar el presupuesto de acción entre rankings topology/control; fijar las mismas vistas anularía el estimando. No se abre un freeze fresco por repetición. No hay arquitectura promovida ni GO/NO-GO y la GPU sigue en cola.
