...
12. **Aislar el aporte de evidencia generativa al aprendizaje**: el [diagnóstico completado](../../experiments/atencion_armonica/RESULTS_OBSERVABLE_SOURCE_RIVALS.md) distingue ajuste, cobertura de candidatos e identidad, sin explicar todos los errores por falta de observación. Su comparación con lectores anteriores no es causal: cambian pool, priors, acceso y objetivos. La continuidad requiere una ablación de evidencia sobre cabeza y pérdida comunes, conservando Local como control fuerte y el ajuste clásico como referencia de sistema. La extensión física set-valued sigue pausada e incompleta; promoción y GO/NO-GO siguen siendo decisiones del usuario.
