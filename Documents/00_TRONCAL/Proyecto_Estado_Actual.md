...
> **Núcleo arquitectónico proporcional**: la cadena CPU ya probó abstención, potencia, localización topológica y tres interfaces de riesgo. R363 mostró que topology transporta ajuste OOF pero no política bajo cobertura simultánea: signed-tail actuó `5/2.040` veces y no superó identidad, absolute ni sham. El diagnóstico post hoc R364 propuso primero un alpha y calibró después sólo su residuo: redujo todos los cuantiles, subió topology a `14/2.040` acciones y recuperó beneficio grouped/balanceado en closure-typed. No separó topology de constant, public-base o control permutado. La candidata de interfaz queda preservada; un eventual test fresco debe poner el valor incremental contra controles como estimando principal. No hay arquitectura promovida ni GO/NO-GO y la GPU sigue en cola.
