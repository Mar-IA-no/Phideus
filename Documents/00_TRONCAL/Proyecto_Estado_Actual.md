...
> **Ground truth proporcional / PPU**: una campaña de dieciséis investigaciones independientes, organizadas en siete olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación causal, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La candidata arquitectónica separa objeto y unidades, operador estructural, constitución o autoridad geométrica, solver y reader. La quinta ola agregó compatibilidad local-global; la sexta separó Fisher–Rao, Aitchison, Wasserstein y GW según semántica, modelo y costo. La séptima incorporó un atlas dinámico y un compositor de sistemas abiertos como candidatas: el primero separa ley, geometría e integrador; el segundo, wiring, semántica, constitución y conducta terminal. Sus contratos obligan a cruzar arquitectura × solver, distinguir energía de simplécticidad y comparar diagramas dados/aprendidos contra MPNNs con evidencia igualada. No hay GO/NO-GO ni arquitectura promovida.
