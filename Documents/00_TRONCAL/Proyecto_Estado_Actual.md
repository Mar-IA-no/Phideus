...
> [!IMPORTANT]
> **Actualizado**: 2026-09-02 (Olas 26–48 de ground truth proporcional integradas y auditadas en su alcance; la Ola 48 tipó la autoridad de la relación proporcional y separó cuatro mediaciones no compensables; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de cuarenta y ocho olas y ciento ocho investigaciones independientes no encontró una geometría universal ni un corpus único. Organizó fuentes analíticas, simulación generativa, cámaras físicas y evidencia externa bajo falsación adversarial y adjudicación ciega. Las Olas 20–40 construyeron contratos para objeto, unidades, experimento, operador, identificabilidad, transformación, grounding, revisión y autoridad; las Olas 26 y 28 añadieron anclas checker-only reproducibles. La Ola 41 redujo Clifford a su tensor exacto; la Ola 42 fijó autoridad antes del proposer; la Ola 43 derivó geometrías tipadas desde relaciones características autorizadas; y las Olas 44–46 convirtieron esas obligaciones en un benchmark capaz de negar crédito y en cinco blueprints de un posible harness tipado. La Ola 47 agregó la autoridad material del target. La Ola 48 tomó como objeto el contrato complementario: `27` casos, `31` URLs usadas o contextuales, `40` claims, `135` celdas y `378` hard negatives separaron autoridad material, meaningfulness bajo escala/origen/gauge, régimen físico o constitutivo y validación discriminante o de transporte. Ningún caso observado reunió los cuatro planos; es una ausencia del corpus y no una imposibilidad universal. El patrón acumulado separa por ello `contrato material del target -> autoridad de la relación y su clase de equivalencia -> manifest de identidad/lineage/access -> proposer con firewall de crédito -> seal/window/query -> factorizer/checker/repair -> status/objeto/policy -> audit/replay -> reader`. Los cinco candidatos C47 y los cinco C48 permanecen como alternativas recuperables, no priorizadas. No hay `A19`, nuevo `P2*`, arquitectura promovida ni decisión GO/NO-GO.
...
*Documento revisado el 2026-09-02. El corte experimental general sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: cuarenta y ocho olas de ground truth proporcional quedaron integradas como base estratificada. Las Olas 26 y 28 aportaron anclas checker-only reproducibles; las Olas 29–40 ampliaron contratos de convención, jerarquía, acción, grounding y revisión; las Olas 41–46 separaron ejecutor, autoridad geométrica, relación característica, crédito y harness prospectivo. La Ola 47 mostró que autorizar un target material y autorizar la relación proporcional atribuida al fenómeno son operaciones distintas; la Ola 48 descompuso esa segunda autorización en cuatro mediaciones no compensables y no halló un caso que las reúna. Los patrones acumulados permanecen recuperables, pero no promovidos. No constituyen una PPU validada ni una decisión GO/NO-GO.*
