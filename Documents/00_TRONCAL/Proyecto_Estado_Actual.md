...
12. **Reorientar desde el contraste geométrico ejecutado**: el lector estructurado completó cuatro tests frescos; el factor conjunto no mostró ventaja clara en polifonía y perdió ARI medio en otros dos shifts. El [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md) prueba ahora si esa decisión puede aprenderse, bajo un [protocolo auditado](../../experiments/atencion_armonica/PROTOCOL_LEARNED_PARTITION_READER.md). El [sexto corte](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_RESOURCE_PROFILE.md) terminó las 36 corridas CPU previstas, con 50 épocas cada una, y la selección común por brazo pasó su auditoría independiente. Checkpoints y calibraciones están preservados. La evaluación IID completó datos, forwards y scoring; después de una interrupción por memoria, un ejecutor versionado recuperó la normalización CPU bajo el límite original y con arrays exactos. El stage medido está en auditoría antes de inferencia: todavía no hay predicciones ni métricas, y los otros tres tests aún no se generaron. Los forwards congelados mantienen su etapa GPU y los intentos fallidos permanecen registrados, sin cambiar escenas ni receta. La extensión física set-valued sigue pausada e incompleta; no hay arquitectura promovida.
