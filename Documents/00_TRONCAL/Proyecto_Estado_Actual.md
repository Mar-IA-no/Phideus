...
> [!IMPORTANT]
> **Actualizado**: 2026-09-07. Nuevo ciclo de [geometría armónica computable](ROADMAP_GENERAL/PROGRAMA_GEOMETRIA_ARMONICA_COMPUTABLE.md): diseño conjunto de representación, arquitectura, pérdida y evaluación, con Atención Armónica como banco inicial. El [diagnóstico CPU](../../experiments/atencion_armonica/RESULTS_ENERGY_PARTITION_AUDIT.md) recuperó por amplitudes solas las 16 mezclas seleccionadas de dos/tres fuentes, sin atribuir ese uso a las redes históricas. El contraste neuronal todavía está en diseño. La extensión física set-valued queda pausada e incompleta; no se promueve una arquitectura.
...
12. **Ejecutar el nuevo ciclo geométrico**: usar el diagnóstico de energía ya cerrado para fijar y auditar una hipótesis que ligue relaciones observables, arquitectura y pérdida, con controles que distingan sus aportes. El goal requiere un contraste experimental completo, no otro cierre de preparación. La extensión física set-valued permanece pausada e incompleta; su preflight histórico sigue conservado, sin promoción ni cierre prospectivo.
...
| `Documents/01_FRENTES_ACTIVOS/Atencion_Armonica/ROADMAP_ATENCION_ARMONICA.md` | Diagnóstico de energía cerrado; protocolo neuronal por fijar y auditar, con Stage B/detección como alternativas preservadas |
