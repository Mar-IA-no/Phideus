...
12. **Completar el contraste del lector aprendido**: el [lector estructurado fijo](../../experiments/atencion_armonica/RESULTS_SOURCE_STRUCTURED_READER.md) cerró cuatro tests sin una ventaja clara del factor conjunto en polifonía. El [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md) completó ahora las 36 corridas y la selección auditada, además de IID, mayor inarmonicidad y mayor polifonía con replay exacto. En el primario de polifonía, Fuente compartida mejora ARI frente a Pares y al control desacoplado, pero no muestra ventaja clara frente a Compatibilidad local; Local conserva menor error absoluto de cantidad de fuentes y menor fragmentación. La revisión independiente de ese slice no halló discrepancias. Familia deformada está en ejecución y las auditorías globales siguen pendientes. Los [recursos y recuperaciones](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_RESOURCE_PROFILE.md) documentan la enmienda de RAM de evaluación sin cambios científicos. La extensión física set-valued sigue pausada e incompleta; no hay arquitectura promovida ni cierre del goal.
