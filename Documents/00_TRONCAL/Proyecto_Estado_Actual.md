...
> [!IMPORTANT]
> **Actualizado**: 2026-09-01 (Olas 26–41 de ground truth proporcional integradas y auditadas en su alcance; la Ola 41 examinó álgebra geométrica/Clifford sobre `47` URLs, redujo el producto geométrico a su tensor de estructura exacto y preservó un ejecutor tipado con control tensorial obligatorio, sin arquitectura, firma, suite, dominio o modelo seleccionados; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña organizada en cuarenta y una olas no encontró una geometría universal ni un corpus único. Propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura emergente separa objeto/unidades, experimento, operador, constitución, identificabilidad, solver, reader y autoridad. Las Olas 20–25 tiparon operador, respuesta, experimento, verdad, transformación set-valued y jurisdicción geométrica. Las Olas 26–28 avanzaron sobre contratos externos de objeto intrínseco, razones operatoriales y jerarquías, con cuatro anclas checker-only en Ola 26 y veintidós suite-bank IDs en Ola 28; la cobertura raw canónica permanece `9 fully adjudicated / 20 partially covered / 4 not adjudicated`. Las Olas 29–30 especificaron guards convencionales y dejaron auditado el plan checker-only B-08 sin implementarlo. Las Olas 31–32 incorporaron estadística algebraica/fibras y CRNT como geometrías tipadas, sin materializar suites neuronales ni promover arquitecturas. Las Olas 33–34 separaron autoridad de dominio, primitive aprendible, corroboración y admisión contractual. La Ola 35 llevó esa separación al problema de transferencia y preservó, sin promoverlo, un loop de proposer tipado, evaluator/checker externo y abstención. La Ola 36 aisló la adquisición que cambia evidencia: no encontró una policy que reuniera transferencia instrumental, medición externa y ganancia epistémica bajo `EA-1..EA-8`; A8 queda `UNRESOLVED` bajo autoridad externa. La Ola 37 distinguió la inducción de una relación de equivalencia (Track E) de la inducción de una acción con flechas y composición (Track A). El positivo Track E exige transiciones indexadas por acciones observadas, observación inyectiva hasta equivalencia de interacción, acciones disponibles puras respecto de un único factor, condición de composición acotada, mundo finito con todas las transiciones y mínimo global. Sólo bajo ese régimen la partición por factor es identificable, y sólo hasta permutación de etiquetas de factor, equivalencia de interacción e isomorfismo latente; una acción completa no enumerada permanece `UNRESOLVED`. Los quince records empíricos atómicos no ofrecieron un caso completo, action-family OOD ni authority holdout. La Ola 38 estudió la composición tipada de claims entre autoridades, pero sus `24` casos fuente no materializaron las claves canónicas `9/7/10`: el cierre conserva `264` estados MC y deja `0` celdas canónicas, sin conteos de cierre ni residuo aprendible adjudicable. La Ola 39 retrocedió hasta el grounding entre señal y objeto proporcional: sus `19` casos separan quantity records, correspondencia incierta e identificabilidad módulo equivalencia, pero dejan `0` celdas y `0` adjudicaciones `TG`. La Ola 40 agregó la revisión temporal del contrato: sobre `47` fuentes y `37` casos tipados, revisión formal, crítica de modelos, provenance/versionado y adaptación aportan capacidades parciales, pero los tres episodios materiales conservan `C2M=NO`, los seis edges carecen de crédito documental y los cuatro ledgers de decisión, replay y materialización permanecen vacíos. La Ola 41 examinó una candidata geométrica concreta: fijadas firma, base y convención, el producto Clifford se reduce exactamente a una contracción con tensor de estructura `C_AB^C`. Sus `47` URLs acreditan autoridad matemática, ejecución material y arquitecturas equivariantes, pero no aíslan una ventaja aprendida frente a un gemelo tensorial exacto con información, capacidad, cómputo y OOD igualados. Quedan preservados un ejecutor Clifford tipado, su control tensorial obligatorio y comparadores equivariant, attention y tensor products; el carril material cerró por límite contractual, no por saturación bibliográfica. El resultado acumulado favorece un dispatch tipado de primitives estrechas con executor/checker externos, equivalencia y abstención explícitas, no una mega-arquitectura. B-08, la materialización CRNT y las alternativas de Olas 33–41 siguen recuperables, no son prioridades ni decisiones ya tomadas. `A10` y `A11` siguen como especializaciones; `A14` sigue como interfaz; no hay `A19`, nuevo `P2*`, GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-09-01. El corte experimental general sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: cuarenta y una olas de ground truth proporcional quedaron integradas como base estratificada. La Ola 26 añadió cuatro anclas checker-only ejecutadas y reproducibles; ese alcance no se extiende a las diecisiete entradas restantes ni a modelos. La Ola 27 conserva veintidós bancos documentales sin ejecución. La Ola 28 ejecutó veintidós suite-bank IDs exactos y reproducibles en cinco suites; el antiguo `22/33` queda sólo como índice histórico entre granularidades distintas y el inventario raw vigente es `9 fully / 20 partial / 4 not`. Las Olas 29–30 especificaron guards convencionales y dejaron auditado el plan B-08 sin implementarlo. Las Olas 31–32 incorporaron estadística algebraica/fibras y CRNT como geometrías tipadas, ambas cerradas documentalmente sin bancos neuronales ni arquitecturas promovidas. Las Olas 33–34 buscaron vacíos y completaron su validación cruzada; la Ola 35 separó reutilización, identidad y transferencia operacional; la Ola 36 mostró que transferir un núcleo, producir medición externa y amortizar selección aparecen por separado; la Ola 37 separó un resultado Track E condicionado por su régimen completo de una acción Track A no identificada y preservó un inductor tipado como alternativa conceptual. La Ola 38 mostró que una encuesta de formalismos locales no puede adjudicarse mientras sus casos no materialicen una unidad contractual canónica. La Ola 39 agregó que los términos de una proporción tampoco existen como nodos autorizados sin quantity kind, unidad/frame, correspondencia, target, equivalencia, incertidumbre y provenance. La Ola 40 agregó que un claim grounded tampoco puede revisarse responsablemente sin identidad de versiones, autoridad, precedencia, diff y replay: sus `47` fuentes y `37` casos no materializan todavía esa cadena completa. La Ola 41 redujo el producto Clifford a su tensor de estructura exacto y dejó sin aislar una contribución aprendida frente a un gemelo tensorial con información, capacidad, cómputo y OOD igualados. Los patrones de proposer–evaluator, evidence-changing action, inducción relación→acción, composición tipada, grounding estratificado, ledger versionado y ejecutor geométrico tipado quedan recuperables, pero no promovidos. Las candidatas acumuladas amplían el atlas con objetos, outputs, equivalencias y jurisdicciones, pero no constituyen una PPU validada. No se declaró GO/NO-GO.*
