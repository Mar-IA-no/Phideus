...
12. **Reorientar desde el contraste geométrico ejecutado**: el lector estructurado completó cuatro tests frescos y sus auditorías de evidencia y alineación. El factor conjunto no muestra ventaja clara sobre controles en polifonía, pierde ARI medio en otros dos shifts y aumenta fragmentación frente a Pares. El siguiente contraste es el [lector aprendido de particiones](../../experiments/atencion_armonica/PLAN_LEARNED_PARTITION_READER.md), con [protocolo auditado](../../experiments/atencion_armonica/PROTOCOL_LEARNED_PARTITION_READER.md). Su ejecutor conecta datos, normalización train-only, entrenamiento recuperable, selección y evaluación. Las auditorías verificaron recuperación, intervenciones, almacenamiento y validación transitiva. Tras la enmienda de tiempos, los [perfiles nuevos](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_RESOURCE_PROFILE.md) entraron en los límites y se obtuvo la autorización de train/calibración. La regla prefijada seleccionó CPU para las cabezas pequeñas y mantiene los forwards congelados en GPU. La preparación de ambos conjuntos está completa, con logits y tensores preservados. El primer entrenamiento se detuvo por un falso rechazo numérico del control de suma de incidencias. La corrección ya fue auditada; el quinto corte completó perfiles y una importación explícita de los datos existentes, cuyo cierre independiente precede al entrenamiento. Se conserva el tiempo consumido, sin reemplazar escenas ni cambiar la receta. No hay entrenamiento completo ni selección experimental. La extensión física set-valued permanece pausada e incompleta, sin promoción ni cierre prospectivo.
