...
*Documento actualizado al corte operativo 2026-03-10 (Gate 5B completamente cerrado; Gate 6 ya con `preflight v6` exitoso y `Exp A+B` submitidos en UNC; Gate 8 ya cerrado `5/5` con `pca=82.6%`; y Escalón 2 ya con `S2-P2.5` fase 1 cerrada y factorial `3x2` corriendo como etapa attention-based).*
