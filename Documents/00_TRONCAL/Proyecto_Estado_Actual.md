...
> [!IMPORTANT]
> **Actualizado**: 2026-09-04 (Olas 26–56 integradas; la prueba prospectiva contextual y su replay exacto ya cerraron en CPU; el núcleo local conserva además sus adjudicaciones de localización y riesgo; corte histórico consolidado al 2026-07-02)
...
*Documento revisado el 2026-09-04. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local ya dispone de una interfaz checker-valid para representar la ruta IID/grouped y de un puerto de utilidad probado sólo sobre fixtures sintéticos. La ruta empírica transporta parcialmente y continúa sin acreditar elección ni valor topológico incremental robusto; se evaluaron cero rutas históricas con utilidad. Toda etapa GPU permanece en cola. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
