...
> **Núcleo arquitectónico proporcional**: la cadena CPU ya probó abstención, potencia, localización topológica y dos interfaces de riesgo. R360 conserva valor parcial de representación; R361 muestra que la escala absoluta conformal actúa sólo en `13/2.032` decisiones y no transporta esa utilidad. El diagnóstico post hoc R362 estima en cambio la cola firmada: topology mejora pinball OOF frente al sham en `4/4` y frente a base en `3/4`, duplica la acción a `24/2.032` y recupera tres intervalos favorables frente a identidad sobre el test ya abierto. No supera al sham en adjudicación y raw-typed es bloqueado por el firewall. La señal justifica una prueba fresca CPU, no acredita una política. No hay arquitectura promovida ni GO/NO-GO y la GPU sigue en cola.
...
*Documento revisado el 2026-09-04. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local ya diagnosticó por CPU una alternativa unilateral después del resultado casi inactivo de la escala absoluta. El próximo corte exige cuatro roles frescos; toda etapa GPU permanece en cola. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
