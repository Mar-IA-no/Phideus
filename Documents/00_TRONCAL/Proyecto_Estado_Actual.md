...
> **Núcleo arquitectónico proporcional**: la cadena CPU ya probó abstención, potencia, localización topológica y dos interfaces de riesgo. R363 adjudicó la cola firmada contra escala absoluta sobre cuatro roles frescos: topology volvió a mejorar el ajuste OOF frente a base y sham, pero esa señal no se convirtió en política. Después del firewall signed-tail actuó sólo en `5/2.040` decisiones brazo-vista, frente a `2/2.040` de absolute-scale; todas fueron grouped, ningún intervalo frente a identidad o absolute excluyó cero y topology no superó al sham matched. La mejora de acción post hoc de R362 no transportó. El próximo diagnóstico CPU debe separar conservatividad de la interfaz y señal de representación mediante proponer primero y calibrar después. No hay arquitectura promovida ni GO/NO-GO y la GPU sigue en cola.
...
*Documento revisado el 2026-09-04. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local ya adjudicó por CPU la cola firmada sobre cuatro roles frescos. El ajuste OOF transporta, pero la política vuelve a casi identidad; el próximo diagnóstico cambia la interfaz de calibración sin reabrir representación. Toda etapa GPU permanece en cola. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
