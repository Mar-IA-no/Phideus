...
> [!IMPORTANT]
> **Actualizado**: 2026-08-30 (Ola 16 de ground truth proporcional integrada y auditada; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de treinta y cuatro investigaciones independientes, organizadas en dieciséis olas integradas, no encontró una geometría universal ni un corpus único. Propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, operador, constitución, identificabilidad, solver, reader y autoridad. La decimoquinta ola agregó `A17/P2t`, completación de distancia bajo un bottleneck de log-ratios y aplicabilidad explícita, y `A18/P2u`, inferencia y ejecución local de una columna de exchange sólo en contextos cuya órbita es identificable por enumeración exacta. La decimosexta no agregó arquitectura: `P2v` quedó como suite diagnóstica de cocientes de forma, mientras el primer generador de circle patterns fue rechazado por una fuga local perfecta y el carril sigue bloqueado antes de `A19/P2w`. Los protocolos registrados están auditados y programáticos, no ejecutados. `A10` y `A11` siguen como especializaciones; `A14` sigue como interfaz; no hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-30. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: dieciséis olas y treinta y cuatro investigaciones de ground truth proporcional quedaron integradas como base estratificada. A17/P2t aísla completación identificable y A18/P2u separa inferencia de órbita y ejecución local. La Ola 16 agregó P2v como diagnóstico de cocientes de forma y bloqueó el carril neuronal de circle patterns al detectar feature-triviality en su generador. Los protocolos siguen sin ejecución; no se promovió arquitectura ni se declaró GO/NO-GO.*
