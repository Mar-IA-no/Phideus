...
> **Ground truth proporcional / PPU**: una campaña de diez investigaciones independientes, organizadas en cuatro olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación causal, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La cuarta ola agregó una candidata arquitectónica que separa operador estructural, leyes constitutivas locales y reader global, con redes resistivas y estequiometría como bancos exactos de mayor poder diagnóstico. No hay GO/NO-GO ni arquitectura promovida.
