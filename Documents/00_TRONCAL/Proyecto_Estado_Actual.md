...
> **Ground truth proporcional / PPU**: una campaña de doce investigaciones independientes, organizadas en cinco olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación causal, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La candidata arquitectónica separa operador estructural, constitución local y reader global; la quinta ola agregó complejos/Hodge y sheaves como maquinaria auditable de compatibilidad local-global, no como ontología natural. Redes resistivas, estequiometría, soluciones manufacturadas y sampling sheaves son los bancos exactos de mayor poder diagnóstico. No hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-29. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: la campaña de ground truth proporcional quedó integrada como base estratificada para PPU/NHG, sin promover arquitectura ni declarar GO/NO-GO.*
