...
12. **Examinar fuentes rivales bajo la observación**: los [cuatro tests completos](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_READER.md) delimitan una utilidad contextual del factor compartido, no una ventaja general. Las auditorías de evidencia y alineación cerraron sin hallazgos materiales abiertos; las métricas y replays quedaron reproducidos. El [siguiente diseño](../../experiments/atencion_armonica/PLAN_OBSERVABLE_SOURCE_RIVALS.md) propone buscar fuentes rivales bajo el puerto observado, diferenciando ajuste competitivo, desajuste de familia e identificabilidad. No se entrenará otra cabeza por el solo hecho de que el oracle del pool sea mejor. Los [recursos y recuperaciones](../../experiments/atencion_armonica/RESULTS_LEARNED_PARTITION_RESOURCE_PROFILE.md) conservan las enmiendas operativas sin cambios científicos. La extensión física set-valued sigue pausada e incompleta; promoción y GO/NO-GO siguen siendo decisiones del usuario.
