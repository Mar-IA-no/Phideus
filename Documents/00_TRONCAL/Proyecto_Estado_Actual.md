...
> [!IMPORTANT]
> **Actualizado**: 2026-09-02 (Olas 26–47 de ground truth proporcional integradas y auditadas en su alcance; la Ola 47 tipó la autoridad del target material y mostró que esa autoridad no valida por sí sola una relación proporcional; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de cuarenta y siete olas y ciento cinco investigaciones independientes no encontró una geometría universal ni un corpus único. Organizó fuentes analíticas, simulación generativa, cámaras físicas y evidencia externa bajo falsación adversarial y adjudicación ciega. Las Olas 20–40 construyeron contratos para objeto, unidades, experimento, operador, identificabilidad, transformación, grounding, revisión y autoridad; las Olas 26 y 28 añadieron anclas checker-only reproducibles. La Ola 41 redujo Clifford a su tensor exacto; la Ola 42 fijó autoridad antes del proposer; la Ola 43 derivó geometrías tipadas desde relaciones características autorizadas; y las Olas 44–46 convirtieron esas obligaciones en un benchmark capaz de negar crédito y en cinco blueprints de un posible harness tipado. La Ola 47 agregó la mediación material: integró `12` casos, `48` fuentes, `135` claims, `180` predicados, `144` hard negatives y `445` joins internos para reconstruir quién autoriza un target, bajo qué método, incertidumbre, jurisdicción, lineage, temporalidad y revisión. Ningún caso autorizó una relación proporcional por la sola fuerza de esa autoridad material. El patrón acumulado separa por ello `contrato material del target -> manifest de identidad/lineage/access -> proposer de relación con firewall de crédito -> seal/window/query -> factorizer/checker/repair -> status/objeto/policy -> audit/replay -> reader`. Los cinco candidatos de Ola 47 —registro de autoridad, escrow prospectivo, bus de evidencia, registro de bridges y gate no compensable— se suman como alternativas recuperables, no priorizadas. No hay `A19`, nuevo `P2*`, arquitectura promovida ni decisión GO/NO-GO.
...
*Documento revisado el 2026-09-02. El corte experimental general sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: cuarenta y siete olas de ground truth proporcional quedaron integradas como base estratificada. Las Olas 26 y 28 aportaron anclas checker-only reproducibles; las Olas 29–40 ampliaron contratos de convención, jerarquía, acción, grounding y revisión; las Olas 41–46 separaron ejecutor, autoridad geométrica, relación característica, crédito y harness prospectivo. La Ola 47 mostró que autorizar un target material y autorizar la relación proporcional atribuida al fenómeno son operaciones distintas. Los patrones acumulados permanecen recuperables, pero no promovidos. No constituyen una PPU validada ni una decisión GO/NO-GO.*
