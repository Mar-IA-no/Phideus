...
| Atención Armónica | Fase 0 cerrada / GO acotado | `v2.1` pasó gate final y `Fase 0` cerró `54/54`: pair-state aporta fuerte; `triangle` gana `OOD-poly` en `AUC/AP` frente a `B-local`, con caveat de calibración `ARI@τ_val` |
...
| `Documents/01_FRENTES_ACTIVOS/Atencion_Armonica/ROADMAP_ATENCION_ARMONICA.md` | Roadmap del frente incubado: `GO` acotado hacia Fase 1, centrado en calibración de `τ` y validación fuera del sintético |
