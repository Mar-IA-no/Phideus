...
> [!IMPORTANT]
> **Actualizado**: 2026-09-03 (Olas 26–55 de ground truth proporcional integradas; el núcleo local ya ejecutó contrato, clásicos, smoke neuronal y desentrelazado CPU de relación×peso×solver con replay byte-exacto; conserva el corte experimental consolidado al 2026-07-02)
...
*Documento revisado el 2026-09-03. El corte experimental general sigue siendo el consolidado al 2026-07-02; la campaña proporcional llegó a cincuenta y cinco olas y el núcleo local ya cuenta con contrato, clásicos, smoke neuronal y desentrelazado CPU ejecutados y reproducidos. El próximo corte diseña una interfaz estática por solver y diagnósticos públicos, sólo por CPU; toda etapa GPU permanece en cola. Esto no constituye una PPU validada ni una decisión GO/NO-GO.*
