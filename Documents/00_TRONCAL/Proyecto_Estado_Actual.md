...
> [!IMPORTANT]
> **Actualizado**: 2026-08-29 (campaña inicial de ground truth proporcional; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de veintiocho investigaciones independientes, organizadas en trece olas, quedó integrada. No encontró una geometría universal ni un corpus único; propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura candidata separa objeto/unidades, operador, constitución, identificabilidad, solver, reader y autoridad. La duodécima ola añadió `P2n`, que separa equivariancia, conmutatividad paired, projectivity en ley y extendibilidad, y `P2o`, que separa tropicalidad exacta, dequantización y ajuste PWL. La decimotercera añadió `A13/P2p`, que trata orientación combinatoria, dualidad y menores sin confundir validez con realizabilidad, y `P2q`, que separa polimatroides, entropías y rango lineal. `A14` queda como interfaz protocolaria con tres candidatos no agregables (`A14a/b/c`), no como una arquitectura ni un efecto común. `A10` y `A11` siguen como especializaciones experimentales; `A12` y `A13`, como candidatas estrechas. No son experimentos ejecutados; no hay GO/NO-GO ni arquitectura promovida.
...
*Documento revisado el 2026-08-29. El corte experimental sigue siendo el consolidado al 2026-07-02; la novedad posterior es documental y programática: trece olas de ground truth proporcional quedaron integradas como base estratificada, con candidatas estrechas hasta A13, la interfaz A14a/b/c y contratos auditables hasta P2q/P5e. A10 y A11 siguen como especializaciones; no se promovió arquitectura ni se declaró GO/NO-GO.*
