...
> [!IMPORTANT]
> **Actualizado**: 2026-08-31 (Olas 26–34 de ground truth proporcional integradas y auditadas en su alcance; las Olas 33–34 cerraron una búsqueda de vacíos y su validación cruzada, sin suite ni modelos; conserva el corte experimental consolidado al 2026-07-02)
...
> **Ground truth proporcional / PPU**: una campaña de sesenta y siete investigaciones independientes y tres reconstrucciones del coordinador, organizada en treinta y cuatro olas, no encontró una geometría universal ni un corpus único. Propuso cuatro fuentes de evidencia —oráculos analíticos, simulación generativa, cámaras físicas y evidencia empírica externa— más falsación adversarial y adjudicación ciega como funciones transversales. La arquitectura emergente separa objeto/unidades, experimento, operador, constitución, identificabilidad, solver, reader y autoridad. Las Olas 20–25 tiparon operador, respuesta, experimento, verdad, transformación set-valued y jurisdicción geométrica. Las Olas 26–28 avanzaron sobre contratos externos de objeto intrínseco, razones operatoriales y jerarquías, con cuatro anclas checker-only en Ola 26 y veintidós suite-bank IDs en Ola 28; la cobertura raw canónica permanece `9 fully adjudicated / 20 partially covered / 4 not adjudicated`. Las Olas 29–30 especificaron guards convencionales y dejaron auditado el plan checker-only B-08 sin implementarlo. Las Olas 31–32 incorporaron estadística algebraica/fibras y CRNT como geometrías tipadas, sin materializar suites neuronales ni promover arquitecturas. La Ola 33 preservó termodinámica de trayectorias, gauge curvo, reducción reticular y `boxplus` porque sus carriles habían auditado ejes distintos. La Ola 34 completó la validación cruzada: las dos primeras conservan autoridad de dominio sin una primitive aprendible nueva en las consultas estudiadas; las dos últimas conservan valor como policy condicionada o banco ingenieril, pero especializan autoridades existentes. Ninguna reúne todavía novedad de jurisdicción y novedad de primitive. El cierre separa contrato especificado de condiciones de admisión satisfechas y adjudica corroboración por claim. No selecciona dominio, suite ni arquitectura. El resultado acumulado favorece un dispatch tipado de primitives estrechas con executor/checker externos, equivalencia y abstención explícitas, no una mega-arquitectura. B-08, la materialización CRNT y las cuatro alternativas siguen recuperables, no son prioridades ni decisiones ya tomadas. `A10` y `A11` siguen como especializaciones; `A14` sigue como interfaz; no hay `A19`, nuevo `P2*`, GO/NO-GO ni arquitectura promovida.
