...
12. **Cerrar el goal acumulativo de geometría proporcional y cambiar de régimen**: `MAPPING-FEASIBILITY` resolvió que el factorial común no es interpretable bajo los contratos vigentes. El próximo trabajo, si se abre, diseña dos protocolos nativos coordinados; el router sólo se reconsidera si una primitive sobrevive a sus controles.
