...
| investigación transversal | Ground truth proporcional | Cuarenta y dos olas, noventa investigaciones independientes y tres reconstrucciones integradas. Las Olas 37–40 separaron relación de acción, composición, grounding y revisión contractual. La Ola 41 agregó el discriminante Clifford; la Ola 42 mostró que métrica, firma, gauge y output necesitan autoridad externa antes del proposer. El inductor tipado, el ledger versionado, H41-A–E y el proposer geométrico bajo checker permanecen alternativas conceptuales/no ejecutadas | Una continuación sólo puede convertir una alternativa en experimento mediante diseño y aprobación propios. H41-X1 exige autoridad de dominio y firma, gemelo tensorial exacto y comparadores con información/capacidad/cómputo/OOD igualados. Elegir geometría por performance no satisface ese contrato. B-08, CRNT y las demás alternativas siguen recuperables; ninguna es cola obligatoria | Usuario |
...
| Ground truth proporcional | PPU/NHG | estratos de evidencia, equivalencias, conjuntos identificados, bancos, adjudicación y ejecutores algebraicos tipados | que exista una métrica proporcional universal, que toda respuesta deba ser puntual o que Clifford aporte una primitive irreductible |
