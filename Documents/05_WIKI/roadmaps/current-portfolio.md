...
| investigación transversal | Ground truth proporcional | Veintinueve olas integradas: Ola 26 ejecutó cuatro anclas checker-only; Ola 27 conserva 22 bancos documentales; Ola 28 ejecutó 22 suite-bank IDs en cinco suites exactas y reproducibles; Ola 29 especificó y reauditó los guards B-03/B-06/B-16 sin ejecutarlos. Cobertura raw: 9 full / 20 partial / 4 not. B-08 sigue como candidato no promovido | Diseñar y auditar, sólo si el usuario decide avanzar, el banco B-08 checker-only. N2-Q queda después; riesgo complete-noisy y N3-T/missing siguen alternativas separadas. Implementar los guards convencionales sólo dentro de un plan aprobado; los 22 bancos de Ola 27 continúan no ejecutados | Usuario |
