...
| investigación transversal | Ground truth proporcional | Cuarenta olas, ochenta y tres investigaciones independientes y tres reconstrucciones integradas. Las Olas 37–39 separaron relación de acción, composición de grounding y grounding de ratio; la Ola 40 agregó el contrato temporal de revisión. Sus 47 fuentes y 37 casos dejan 3/3 episodios materiales con `C2M=NO`, seis enlaces sin crédito y cuatro ledgers vacíos. El inductor tipado y el ledger versionado permanecen alternativas conceptuales `NO-A19` / `NO-ARCHITECTURE / NOT-EXECUTED`, no suite ni modelo | Una continuación sólo puede convertir una alternativa en experimento mediante diseño y aprobación propios. Antes de ejecutar debe materializar la unidad contractual o el ledger correspondiente; no reinterpretar retrospectivamente los raws. B-08, CRNT y las demás arquitecturas históricas permanecen recuperables; ninguna es cola obligatoria | Usuario |
