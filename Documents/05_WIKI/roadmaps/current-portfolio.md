...
| investigación transversal | Ground truth proporcional | Cuarenta y cinco olas, noventa y nueve investigaciones independientes y tres reconstrucciones integradas. Las Olas 37–40 separaron relación de acción, composición, grounding y revisión contractual. La Ola 41 agregó el discriminante Clifford; la Ola 42 fijó autoridad antes del proposer; la Ola 43 agregó la cadena relación característica → factorizer/checker → output geométrico tipado; la Ola 44 definió un benchmark capaz de negar crédito; y la Ola 45 mostró que sus piezas públicas de autoridad material, sellado y atribución todavía no coexisten en un bundle tricarril. H41-A–E, H43-A–F y H44-A–F permanecen alternativas conceptuales/no ejecutadas | Una continuación sólo puede convertir una alternativa en experimento mediante diseño y aprobación propios. El discriminante requiere un source-case atómico con autoridad externa de targets, lineage, acceso por fase y cadena completa de artefactos; H41-X1 y C219-03 siguen bloqueados mientras esas condiciones no estén materializadas. Elegir geometría por performance, sumar virtudes de contratos distintos o medir sólo la salida post-checker no satisface el contrato. B-08, CRNT y las demás alternativas siguen recuperables; ninguna es cola obligatoria | Usuario |
