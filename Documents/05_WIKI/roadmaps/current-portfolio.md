...
| investigación transversal | Ground truth proporcional | Seis olas y catorce investigaciones integradas | Elegir un primer banco exacto entre tracks dimensional/composicional, conservativo/local-global o estadístico/transporte tipado | Usuario |
...
| PPU/NHG | tracks exactos separados de unidades/Buckingham, composición/ciclos, conservación/equivalencia, compatibilidad local-global y geometrías estadísticas/de medidas tipadas antes de la mega-arquitectura | confundir adimensionalidad, similitud, balance, constitución, residual, obstrucción, Fisher/Aitchison, costo/mecanismo, autosimilitud y alometría |
