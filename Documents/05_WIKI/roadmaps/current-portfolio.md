...
| investigación transversal | Ground truth proporcional | Cincuenta y tres olas, ciento ocho investigaciones independientes y tres reconstrucciones integradas. La Ola 53 transportó incertidumbre marginal hacia regret esperado: ganó compatibilidad, perdió accuracy y no redujo regret de forma concluyente; la abstención ordenó riesgo, pero la dependencia residual y el error de cardinalidad falsaron la factorización Bernoulli como resolución suficiente | Probar en CPU un posterior conjunto regularizado sobre los quince conjuntos no vacíos, manteniendo encoder, logits, utilidad, pérdida y splits congelados. Comparar contra marginal raw/Platt y conjunto duro. El lockbox permanece intacto; GPU se informa antes. Ninguna opción está promovida y el GO/NO-GO pertenece al usuario | Codex |
