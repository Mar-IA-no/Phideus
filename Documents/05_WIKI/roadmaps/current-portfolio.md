...
| investigación transversal | Ground truth proporcional | Cuarenta y cuatro olas, noventa y seis investigaciones independientes y tres reconstrucciones integradas. Las Olas 37–40 separaron relación de acción, composición, grounding y revisión contractual. La Ola 41 agregó el discriminante Clifford; la Ola 42 fijó autoridad antes del proposer; la Ola 43 agregó la cadena relación característica → factorizer/checker → output geométrico tipado; la Ola 44 convirtió lineage OOD, crédito pre/post-checker y abstención bajo shift en un contrato de benchmark capaz de negar crédito. H41-A–E, H43-A–F y H44-A–F permanecen alternativas conceptuales/no ejecutadas | Una continuación sólo puede convertir una alternativa en experimento mediante diseño y aprobación propios. El discriminante requiere un dominio, una autoridad externa de targets y una cadena completa de artefactos; H41-X1 sigue bloqueado mientras esas condiciones no estén materializadas. Elegir geometría por performance, llamar OOD a un split o medir sólo la salida post-checker no satisface el contrato. B-08, CRNT y las demás alternativas siguen recuperables; ninguna es cola obligatoria | Usuario |
