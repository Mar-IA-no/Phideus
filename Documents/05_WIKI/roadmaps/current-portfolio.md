...
| investigación transversal | Ground truth proporcional | Veintiocho olas integradas: Ola 26 ejecutó cuatro anclas checker-only; Ola 27 conserva 22 bancos documentales; Ola 28 ejecutó 22 suite-bank IDs en cinco suites exactas y reproducibles. Cobertura raw: 9 full / 20 partial / 4 not. R82-R84 seleccionaron B-08 como candidato no promovido | Diseñar y auditar, sólo si el usuario decide avanzar, el banco B-08 checker-only. N2-Q queda después; riesgo complete-noisy y N3-T/missing siguen alternativas separadas. Los 22 bancos de Ola 27 continúan no ejecutados | Usuario |
