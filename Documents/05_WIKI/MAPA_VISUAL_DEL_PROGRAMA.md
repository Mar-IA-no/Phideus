...
flowchart LR
    ...
    GT["INVESTIGACION: ground truth proporcional<br/>38 olas · 76 investigaciones independientes + 3 reconstrucciones<br/>tipar objeto → medir → inducir relación/acción → componer claims → adjudicar"]
