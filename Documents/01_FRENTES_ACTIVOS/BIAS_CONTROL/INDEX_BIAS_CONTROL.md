...
- `17_GATE_10_MECHANISM_SWEEP/`
  Barrido descriptor × mecanismo para separar contenido de inyección en audio-only. Ya quedó cerrado `9/9` y la lectura final es `concat > FiLM/pca >> attn_bias`, con `a7-concat=76.4%` como mejor arm del gate.
  - `README.md`
