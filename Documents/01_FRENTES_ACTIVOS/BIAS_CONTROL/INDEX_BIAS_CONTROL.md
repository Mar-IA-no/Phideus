...
> [!NOTE]
> **Corte operativo (2026-02-26):** Gate 4.4 permanece cerrado como bloque arquitectural, Gate 4.5 queda en cierre operativo y Gate 5B mantiene paquete local consolidado (`Test12/01/04/03/06/08/10/Test09` cerrados). En Test11 perceptual ya se cerraron barridos de inferencia `midi2events` (`D0`, `a4r`) y barridos finos GPU de `D0`; run activo: `audio2events` en `D0` con `a4r` en cola. Pendientes UNC: `Test02` y `Test05`.
