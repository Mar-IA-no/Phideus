...
Esto precisa una geometría probabilística que hasta ahora permanecía implícita.
Una región compatible no es la yuxtaposición de cuatro eventos independientes;
es un objeto conjunto dentro del retículo finito de subconjuntos no vacíos. El
próximo discriminante puede representarlo mediante una distribución
regularizada sobre sus quince estados, con potenciales de pertenencia,
interacciones y cardinalidad. El cambio no presupone un encoder más poderoso:
pregunta si el reader pierde información al factorizar un objeto relacional que
el target presenta como conjunto.
