...
Ocho contratos atraviesan esa base sin convertirse en nuevas fuentes positivas. A medición, adquisición, mapa entre escalas y tarea perceptual se suman escala de medición, abstracción causal, familia proyectiva y operador tropical. Los dos últimos declaran respectivamente leyes, kernels, samplers y extendibilidad entre índices; y semiring, gauge, soporte, active sets y pérdida de información por valuación. Ninguno reemplaza a una fuente de autoridad: impiden atribuir a la red lo que proviene del aparato, la política, el mapa, el readout, el sampler o una aproximación algebraica mal tipada.
...
Las doce olas y veintiséis investigaciones aportan una base para diseñar experimentos menos ciegos y una definición falsable de capacidad proporcional. No demuestran que toda proporción sea informacionalmente privilegiada, que triangle, Hodge o sheaves sean operadores canónicos, que Fisher/OT sean geometrías intrínsecas del mundo, que una forma simpléctica identifique la ley, que una categoría valide la física de sus componentes, que renormalización seleccione un coarse-graining natural universal, que un efecto de razón revele una métrica neural única, que una macrovariable predictiva sea causal, que equivariancia implique projectivity ni que toda función piecewise-linear sea tropical en sentido sustantivo. Tampoco demuestran que la armonía musical constituya la geometría general de la naturaleza ni declaran GO/NO-GO.
