...
| **H3 - Cross-modality** | Diferentes dominios comparten estructura de ratios | **EN INVESTIGACION** — Gate 5B local consolidado (T12/01/04/03/06/08/10), Test09 parcial (`D0` y `d4a4`) |
