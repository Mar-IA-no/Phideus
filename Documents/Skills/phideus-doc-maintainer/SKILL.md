...
- In practice, `select_targets.py` may still return a broader front-doc set for historical safety; when that happens, reduce manually to the minimum subset that must change for the current event.
