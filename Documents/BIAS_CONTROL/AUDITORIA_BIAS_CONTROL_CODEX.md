...
- `BIAS_CONTROL = Escalon 1` de `Documents/Rosetta_triplescaloneta.md`.
...
- `Documents/BIAS_CONTROL/Planes_Claude/plan_gate4.md`
- `Documents/BIAS_CONTROL/Planes_Claude/plan_gate4_codex.md`
